...
(function() {
  ...
  gulp.task("js", function() {
    return gulp.src(config.srcFolder + "/js/*.js").pipe(uglify()).pipe(gulp.dest(targetFolder + "/js/"));
  });
  ...
  gulp.task("build", function() {
    ...
    return runSequence('clean', ["browserify", "usemin", 'images', 'js'], ["cssmin", "uglify", 'htmlmin']);
  });

  gulp.task('dev', function() {
    targetFolder = config.tmpFolder;
    return runSequence('clean', ["browserify", "images", "usemin", 'js'], ['server', "watch"]);
  });
